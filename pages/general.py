...
# Datos de acceso a Gmail
MY_EMAIL = st.secrets["mail"]["MY_EMAIL"]
MY_PASSWORD = st.secrets["mail"]["MY_PASSWORD"]


# Función para enviar correo electrónico
def enviar_alerta_email(subject, body):
    msg = MIMEMultipart()
    msg['From'] = MY_EMAIL
    msg['To'] = 'mxlopez8@gmail.com'
    msg['Subject'] = subject
...
def get_alert_sent_status():
    return {'sent': False, 'timestamp': None}
...
if not proyectos_con_errores_altos.empty:
    if (alert_status['timestamp'] is None or
        ...
        enviar_alerta_email("Alerta de Errores en Proyectos", mensaje_alerta)
